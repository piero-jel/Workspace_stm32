...
#######################################################################################
##
## Definimos los directorios donde colocaremos los archivos compilados
##
#######################################################################################
OBJ_PATH := out/obj
APP_PATH := out/app
...
#######################################################################################
##
## -- incluimos el makefile del proyecto
##
#######################################################################################
...
help:
	...
	$(CMD_PRINT) "make new\t: Este borra todos los archovos compilados y recompila  \n\t\t  todo el proyecto desde el inicio"
